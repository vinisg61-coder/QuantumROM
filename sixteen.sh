...
# A52s-specific patches for camera, hotspot, audio and keystore
PATCH_CAMERA_A52S "$FIRM_DIR/$TARGET_DEVICE"
PATCH_WIFI_HOTSPOT "$FIRM_DIR/$TARGET_DEVICE"
PATCH_AUDIO_A52S "$FIRM_DIR/$TARGET_DEVICE"
PATCH_KEYSTORE_A52S "$FIRM_DIR/$TARGET_DEVICE"
PATCH_VOLD_A52S "$FIRM_DIR/$TARGET_DEVICE"
